...
class Bot(commands.Bot):
    def __init__(self):
        ...
        self.statsy_mongo = AsyncIOMotorClient(os.environ.get('STATSYMONGO'))
        self.client = clashroyale.Client(os.environ.get('ROYALEAPI'), is_async=True, session=self.session, timeout=5)
