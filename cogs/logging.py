...
class Logging():
    ...
    async def on_member_join(self, member):
        ...
        embed.add_field(name="Stu's Army 2", value='3000 Trophies [Read More](https://statsroyale.com/clan/29UQQ282)', inline=True)
        embed.add_field(name="Stu's Army 3", value='2600 Trophies [Read More](https://statsroyale.com/clan/28JU8P0Y)', inline=True)
        embed.add_field(name="Stu's Army 4", value='2200 Trophies [Read More](https://statsroyale.com/clan/8PUUGRYG)', inline=True)
        embed.add_field(name="Stu's Army 5", value='1600 Trophies [Read More](https://statsroyale.com/clan/8YUU2CQV)', inline=True)
